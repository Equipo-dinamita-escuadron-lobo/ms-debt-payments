...
public interface IPortfolioWriteOffRestMapper {
     ...
     * OJO: Este método asume que el enriquecimiento (datos de facturas) ya se ha hecho.
     * Nuestro servicio devuelve el DTO enriquecido, por lo que este mapper
     * no será usado directamente para la conversión compleja, pero es bueno tenerlo.
     */
